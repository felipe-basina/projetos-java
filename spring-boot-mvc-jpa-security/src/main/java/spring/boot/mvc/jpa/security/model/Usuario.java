package spring.boot.mvc.jpa.security.model;
...
@Entity(name = "usuario")
@Table(name = "REGISTRO_TBL", schema = "jpa")
public class Usuario implements Serializable {
	...
	public UsuarioForm getUsuarioFormFromUsuarioEntity() {
		return new UsuarioForm(this.getId(), this.getNome(), this.getUltimoNome(), this.getTelefone());
	}
