...
public class MensagemWSServiceLocator extends org.apache.axis.client.Service
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface)
			throws javax.xml.rpc.ServiceException {
		try {
			if (br.com.spring.framework.web.security.ws.MensagemWS.class
	...
	public javax.xml.namespace.QName getServiceName() {
		return new javax.xml.namespace.QName(
				"http://ws.security.web.framework.spring.com.br/", "MensagemWSService");
	}
	...
	public java.util.Iterator getPorts() {
		if (ports == null) {
			...
			ports.add(new javax.xml.namespace.QName(
					"http://ws.security.web.framework.spring.com.br/", "MensagemWSPort"));
		}
