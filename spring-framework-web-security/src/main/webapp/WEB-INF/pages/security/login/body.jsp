...
<div id="form">
	...
	<br>
	<div id="msg-box" class="none">&nbsp;
		<sc:messages />
	</div>
	<br>
	
<!-- 	<form name="logonForm" method="post" action="j_spring_security_check" onsubmit="javascript:return validateLogonForm(this);"> -->
	<form name="logonForm" method="post" action="j_spring_security_check">
	...
	<input name="button" type="reset" class="button" value="<spring:message code="label.clean"/>" />
</form>
