...
<div id="form">
	...
	<form:form method="post" action="${pageContext.request.contextPath}/save.do" commandName="command">
		...
		<input type="button" onclick="javascript:getLastId();" 
			value="<spring:message code='spring.boot.form.botao.ultimoid' />" />
		<input type="button" onclick="javascript:getLastIdd();" 
			value="<spring:message code='spring.boot.form.botao.ultimoid' />-v2" />
	</form:form>
