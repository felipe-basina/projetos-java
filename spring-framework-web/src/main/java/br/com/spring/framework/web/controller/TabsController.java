...
import br.com.spring.framework.web.ws.MensagemWSRequest;
import br.com.spring.framework.web.ws.MensagemWSResponse;
import br.com.spring.framework.web.ws.client.MensagemWSCliente;
import br.com.spring.framework.web.ws.client.ParametroInvalidoBusinessException;
...
public class TabsController {
	...
	public ModelAndView getMessage(
		...
		try {
			...
			map.put("mensagem", this.logException(e));
