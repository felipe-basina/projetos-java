...
<div id="form">
	...
	<form:form method="post"
		action="${pageContext.request.contextPath}/save.do"
		commandName="command">
		<form:hidden path="id" />
		<table style="margin: 0;" border="0">
			...
			<tr>
				...
				<td><form:input class="textbox campoTelefone" path="telefone"
						id="telefone" /></td>
				<td><span class="help-inline"><form:errors
		...
		<a href="<c:url value="/"/>"
			onclick="javascript:return confirm('<spring:message code='spring.boot.form.msg.reiniciar' />');">
			<spring:message code="spring.boot.form.reiniciar" />
		</a>
	</form:form>
