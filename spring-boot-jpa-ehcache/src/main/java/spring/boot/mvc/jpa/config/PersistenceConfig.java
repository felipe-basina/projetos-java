...
public class PersistenceConfig {
	...
	private static final String PROPERTY_PACKAGES_TO_SCAN = "spring.boot.mvc.jpa.model";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		jpaProperties.put(PROPERTY_NAME_HIBERNATE_GENERATE_STATISTICS, environment
				.getRequiredProperty(PROPERTY_NAME_HIBERNATE_GENERATE_STATISTICS));
